...
<div class="card-deck" id="bg-color">
    <div class="card" id="bg-color">
        ...
        <pre class="card-text" id="about-heading">
            ...
            Siste halvåret har blitt å gjøre oppgaven vår ferdig.</pre>
        </div>
        <div class="card" id="bg-color">
            <h2 class="card-title">New Home</h2>
            <pre class="card-text" id="about-heading">
            New Home er et sted for deg, som har mange linker og
            liker å he et system på ting.
            ...
            Med en litt enklere hverddag blir livet litt bedre.</pre>
        </div>
    </div>
</div>
